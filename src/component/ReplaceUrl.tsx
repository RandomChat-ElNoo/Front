...
// export default function LinkifyText({ text, setter }: Props) {
//   const urlRegex =
//     /(?:https:\/\/)(?:www\.)?[-a-zA-Z0-9@:%._+~#=]{2,256}\.[a-z]{2,6}(?:[-a-zA-Z0-9@:%_+.~#?&//=]*)/g;
...
//   const parts = text.replace(urlRegex, url => {
//     return `<a href="/naver.com" onClick={handleClick}>${url}</a>`;
//   });
